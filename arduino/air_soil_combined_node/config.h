...
// ============================================
// 노드 13, 14, 15 중 하나로 설정
#define ZONE_ID "13"  // 대기 센서 Zone ID: 13, 14, 15
#define TANK_ID "13"  // 토양 센서 Tank ID: 13, 14, 15
...
// MQTT Client ID (자동 생성: WasabiCombined_Zone13)
#define MQTT_CLIENT_ID_PREFIX  "WasabiCombined_Zone"

// MQTT Topics
// 대기 센서 (Air)
#define MQTT_AIR_TOPIC_PREFIX      "sensor/air/zone"
#define MQTT_AIR_DATA_SUFFIX       "/data"

// 토양 센서 (Soil)
#define MQTT_SOIL_TOPIC_PREFIX     "sensor/soil/tank"
#define MQTT_SOIL_DATA_SUFFIX      "/data"

// 하트비트 (Combined)
#define MQTT_HEARTBEAT_PREFIX      "sensor/combined/zone"
#define MQTT_HEARTBEAT_SUFFIX      "/heartbeat"

// 상태
#define MQTT_STATUS_PREFIX         "sensor/combined/zone"
