...
// 노드 식별 정보
// ============================================
#define NODE_ID   "20"               // 수위 센서 노드 번호 (고정)
#define NODE_TYPE "water_level"      // 노드 유형 식별자

// ============================================
// WiFi 설정
// ============================================
#define WIFI_SSID           "kunlim"       // ← 실제 WiFi 이름으로 변경
#define WIFI_PASSWORD       "1qazxsw212"   // ← 실제 WiFi 비밀번호로 변경
...
// ============================================
#define MQTT_SERVER   "192.168.0.103"       // ← HA VM(VirtualBox) IP로 변경
#define MQTT_PORT     1883

// ⚠️ Mosquitto 브로커 인증 정보 (HA add-on 설정과 동일하게)
#define MQTT_USER     "kunlim"          // ← HA Mosquitto 사용자명
#define MQTT_PASSWORD "1qazxsw212" // ← 실제 비밀번호로 변경
...
#define MQTT_DATA_TOPIC      "sensor/water_tank/data"
...
// ============================================
#define TANK_HEIGHT_CM   56.0   // 탱크 내부 높이 (cm)
