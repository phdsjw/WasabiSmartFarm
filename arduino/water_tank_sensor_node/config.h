...
#define MQTT_CLIENT_ID "WasabiWaterTank"     // MQTT 클라이언트 ID

// MQTT 토픽
#define MQTT_TOPIC_DATA "sensor/water_tank/data"        // 센서 데이터
#define MQTT_TOPIC_HEARTBEAT "sensor/water_tank/heartbeat"  // 하트비트
#define MQTT_TOPIC_STATUS "sensor/water_tank/status"    // 상태 정보
