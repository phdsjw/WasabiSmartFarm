 ...
 * 날짜: 2025-12-27
 */
#ifndef ARDUINO_AIR_SOIL_COMBINED_NODE_G102_CONFIG_H
#define ARDUINO_AIR_SOIL_COMBINED_NODE_G102_CONFIG_H
#include <Arduino.h>
...
#define ZONE_ID "2"  // 기본 구역 ID (g102)
#define TANK_ID "2"  // 기본 탱크 ID (g102)
...
#define MODBUS_BAUDRATE        9600    // SEN0604 보드레이트 (지원: 2400/4800/9600)
...
#endif // ARDUINO_AIR_SOIL_COMBINED_NODE_G102_CONFIG_H
