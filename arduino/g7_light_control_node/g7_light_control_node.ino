/*
 * Wasabi SmartFarm - 조명 제어 노드
 * 
 * 기능:
 * - Grow Light on/off 제어
 * - WiFi 연결
 * - MQTT 명령 수신 및 상태 보고
 * 
 * Hardware:
 ...
 * 
 * MQTT Topics:
 * - Command: smartfarm/wasabi/g7_light_ctrl/g7-01/cmd/light
 * - State:   smartfarm/wasabi/g7_light_ctrl/g7-01/state
 * 
 * 작성자: 서준원
 * 버전: v1.0.0
 * 날짜: 2026-02-25
...
MQTTHandler mqttHandler(&lightControl);
...
void setup() {
  ...
  // 조명 제어 초기화
  Serial.println(F("\n[SETUP] Initializing light control..."));
  lightControl.begin();
  Serial.println(F("[SETUP] Light control initialized"));
  ...
  // 초기화 완료
  Serial.println(F("\n========================================"));
  Serial.println(F("  Light Control Node Ready!"));
...
void printStartupMessage() {
  ...
  Serial.println(F("  Light Control Node"));
  Serial.println(F("========================================"));
  ...
  Serial.println(F("  Actuator: Single Channel Relay (Grow Light)"));
